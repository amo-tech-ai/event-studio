    ...
    <div className="min-h-screen flex">
        ...
        <div className="w-full max-w-md">
          ...
          <p className="text-foreground/60 mb-8">
            {isLogin 
              ...
              : "Get started with EventOS today"}
          </p>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/10 to-primary/5 items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Plan events that matter</h2>
          <p className="text-lg text-foreground/70">
            Join thousands of organizers using AI to create, manage, and grow successful events.
          </p>
        </div>
      </div>
    </div>
