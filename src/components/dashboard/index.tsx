// Reusable Dashboard Component Patterns for EventOS
// Extracted from .claude/skills/frontend-dashboard/resources/component-patterns.tsx
...
interface StatusBadgeProps {
  status: 'active' | 'draft' | 'cancelled' | 'completed' | 'pending' | 'published';
  className?: string;
}
